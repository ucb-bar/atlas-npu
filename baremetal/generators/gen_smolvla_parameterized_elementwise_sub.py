#!/usr/bin/env python3
"""Generate test vectors for `smolvla_parameterized_elementwise_sub.S` (64x64).

Port of jrmills20 parameterized_elementwise_sub.py (npu-model-tapeout-kernels).
Golden comes from atlas's `VectorEngineModel` via `run_binary_rows("sub", ...)`.
"""
