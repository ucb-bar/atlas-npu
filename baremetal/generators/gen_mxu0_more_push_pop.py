#!/usr/bin/env python3
"""
gen_mxu0_more_push_pop.py
Generate test vectors for mxu0_more_push_pop.S.
...
Assembly flow:
  DRAM → VMEM → VLOAD → TRF → MXU0 → TRF → VSTORE → VMEM → DRAM

VMATPUSH.ACC.BF16.MXU0 reads two TRFs:
