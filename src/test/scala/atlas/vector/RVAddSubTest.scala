// ============================================================================
// RVAddSubTest.scala — BF16 add/sub vector tests for the RV-style vector
// datapath.
//
...
object PersistentVcsRVAddSubSimulator extends Simulator[VcsBackend] with PeekPokeAPI {

  private val test_name = "RVAddSubTest"
...
class RVAddSubTest extends AnyFlatSpec with Matchers with PeekPokeAPI {
